...
(() => {
  ...
  var API = function() {
    ...
    for (var sceneKey in SCENES)
      CONFIG3[sceneKey] = SCENES[sceneKey];
    ...
    function drawReveal(tl, el2, t, d) {
      ...
      return tl.to(rect, {
        ...
        ease: t.ease || CONFIG3.global.ease,
        data: null
      }, t.at || 0);
    }
    function buildScene(name, root, d) {
      var scene = CONFIG3[name];
      ...
      Object.keys(scene.tracks || {}).forEach(function(key) {
        ...
        var vars = { duration: t.duration != null ? t.duration : CONFIG3.global.duration, autoAlpha: 0, data: key };
        if (t.ease)
          vars.ease = t.ease;
        switch (t.preset) {
          case "from-bottom":
